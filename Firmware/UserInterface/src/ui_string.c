...
{
  /* UI_STR_KEY_0       */ {"   0", "KEY-0", "KEY-0  "},
  /* UI_STR_KEY_1       */ {"   1", "KEY-1", "KEY-1  "},
  /* UI_STR_KEY_2       */ {"   2", "KEY-2", "KEY-2  "},
  /* UI_STR_KEY_3       */ {"   3", "KEY-3", "KEY-3  "},
  /* UI_STR_KEY_4       */ {"   4", "KEY-4", "KEY-4  "},
  /* UI_STR_KEY_5       */ {"   5", "KEY-5", "KEY-5  "},
  /* UI_STR_KEY_6       */ {"   6", "KEY-6", "KEY-6  "},
  /* UI_STR_KEY_7       */ {"   7", "KEY-7", "KEY-7  "},
  /* UI_STR_KEY_8       */ {"   8", "KEY-8", "KEY-8  "},
  /* UI_STR_KEY_9       */ {"   9", "KEY-9", "KEY-9  "},
